...
################################################################################
## Form generated from reading UI file 'ComSysTrainerUIIJRQik.ui'
##
...
class Ui_ComSys(object):
    def setupUi(self, ComSys):
        ...
        ComSys.resize(900, 600)
        ComSys.setFixedSize(900,600)
        ...
        self.tabWidget.setMaximumSize(QSize(890, 550))
        font4 = QFont()
        ...
        self.AM_graph_layout.setGeometry(QRect(195, 0, 680, 510))
        ...
        self.MplWidgetAM.setMaximumSize(QSize(880, 490))
...
"border-radius: 5px;")
        ...
        self.dataInpBox.setGeometry(QRect(0, 60, 191, 221))
        ...
        self.label_5 = QLabel(self.horizontalFrame1)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setFont(font6)

        self.horizontalLayout_3.addWidget(self.label_5)

        self.carrierFreqInput = QSpinBox(self.horizontalFrame1)
        ...
        self.horizontalFrame2 = QFrame(self.dataInpBox)
        self.horizontalFrame2.setObjectName(u"horizontalFrame2")
        sizePolicy1.setHeightForWidth(self.horizontalFrame2.sizePolicy().hasHeightForWidth())
        self.horizontalFrame2.setSizePolicy(sizePolicy1)
        self.horizontalFrame2.setMaximumSize(QSize(16777215, 50))
        self.horizontalLayout_2 = QHBoxLayout(self.horizontalFrame2)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.label_4 = QLabel(self.horizontalFrame2)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setFont(font6)

        self.horizontalLayout_2.addWidget(self.label_4)

        self.carrierAmpInput = QDoubleSpinBox(self.horizontalFrame2)
        ...
        self.modulateBtnAM.setGeometry(QRect(25, 300, 150, 50))
        font7 = QFont()
        ...
        self.modulateBtnAM.setFont(font7)
...
"}")
        ...
        self.clearBtnAM.setGeometry(QRect(25, 390, 150, 50))
        self.clearBtnAM.setFont(font7)
...
"}")
        ...
        self.label_8.setGeometry(QRect(16, 20, 171, 31))
        font8 = QFont()
        ...
        self.modulateBtnFM.setFont(font7)
...
"border-radius: 5px;")
        ...
        self.msgFreqInputFM.setFont(font5)
        ...
        self.carrierFreqInputFM.setFont(font5)
        ...
        self.modIndexInputFM.setFont(font5)
        ...
        self.ASK_graph_layout.setGeometry(QRect(195, 0, 680, 510))
        ...
        self.ASK_graph_layout.setMaximumSize(QSize(880, 510))
...
"border-radius: 5px;")
        ...
        self.modulateBtnASK.setGeometry(QRect(25, 300, 150, 50))
...
"}")
        ...
        self.dataInpBox_3.setGeometry(QRect(0, 90, 191, 161))
        ...
        self.carrierFreqInputASK.setFont(font5)
...
"}")
        ...
        self.clearBtnFSK.setGeometry(QRect(25, 390, 150, 50))
...
"}")
        ...
        self.label_17.setGeometry(QRect(16, 20, 171, 61))
        ...
        self.modulateBtnFSK.setGeometry(QRect(25, 300, 150, 50))
...
"}")
        ...
        self.dataInpBox_4.setGeometry(QRect(0, 90, 191, 201))
        ...
        self.carrierFreq1InputFSK.setFont(font5)
        ...
        self.carrierFreq2InputFSK.setFont(font5)
        ...
        self.FSK_graph_layout.setGeometry(QRect(195, 0, 680, 510))
...
"border-radius: 5px;")
        ...
        self.carrierFreqInputPSK.setFont(font5)
...
"border-radius: 5px;")
        ...
        self.modulateBtnPAM.setFont(font7)
...
"}")
        ...
        self.clearBtnPAM.setFont(font7)
...
"border-radius: 5px;")
        ...
        self.clearBtnPWM.setFont(font7)
...
"}")
        ...
        self.modulateBtnPWM.setFont(font7)
...
"border-radius: 5px;")
    ...
    def retranslateUi(self, ComSys):
        ComSys.setWindowTitle(QCoreApplication.translate("ComSys", u"ComSys Trainer Kit", None))
        self.label.setText(QCoreApplication.translate("ComSys", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#de122f;\">ComSys Signal Modulation Trainer Kit</span></p></body></html>", None))
        self.label_3.setText(QCoreApplication.translate("ComSys", u"Made with \u2764  by Soumadip Dey", None))
        self.label_2.setText(QCoreApplication.translate("ComSys", u"V1.0.0", None))
        ...
        self.label_7.setText(QCoreApplication.translate("ComSys", u"Msg. Freq. (Hz)     ", None))
        self.label_6.setText(QCoreApplication.translate("ComSys", u"Msg. Amp (V)       ", None))
        self.label_5.setText(QCoreApplication.translate("ComSys", u"Carrier Freq (Hz)  ", None))
        self.label_4.setText(QCoreApplication.translate("ComSys", u"Carrier Amp (V)   ", None))
        self.modulateBtnAM.setText(QCoreApplication.translate("ComSys", u"Modulate", None))
        self.clearBtnAM.setText(QCoreApplication.translate("ComSys", u"Clear", None))
        self.label_8.setText(QCoreApplication.translate("ComSys", u"Amplitude Modulation", None))
        ...
        self.modulateBtnASK.setText(QCoreApplication.translate("ComSys", u"Modulate", None))
        self.label_11.setText(QCoreApplication.translate("ComSys", u"Binary Message\n"
"Size 2 / 4 / 8 / 16 Only", None))
        self.messageInputASK.setPlaceholderText(QCoreApplication.translate("ComSys", u" Enter Binary String", None))
        self.label_14.setText(QCoreApplication.translate("ComSys", u"Carrier Freq (Hz)  ", None))
        self.label_16.setText(QCoreApplication.translate("ComSys", u"<html><head/><body><p>Amplitude Shift </p><p>Keying</p></body></html>", None))
        self.clearBtnASK.setText(QCoreApplication.translate("ComSys", u"Clear", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QCoreApplication.translate("ComSys", u"ASK", None))
        self.clearBtnFSK.setText(QCoreApplication.translate("ComSys", u"Clear", None))
        self.label_17.setText(QCoreApplication.translate("ComSys", u"<html><head/><body><p>Frequency Shift </p><p>Keying</p></body></html>", None))
        self.modulateBtnFSK.setText(QCoreApplication.translate("ComSys", u"Modulate", None))
        self.label_15.setText(QCoreApplication.translate("ComSys", u"Binary Message\n"
"Size 2 / 4 / 8 / 16 Only", None))
        self.messageInputFSK.setPlaceholderText(QCoreApplication.translate("ComSys", u" Enter Binary String", None))
        self.label_18.setText(QCoreApplication.translate("ComSys", u"Carrier Freq 1 (Hz)", None))
        self.label_19.setText(QCoreApplication.translate("ComSys", u"Carrier Freq 2 (Hz)", None))
...
"Size 2 / 4 / 8 / 16 Only", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), QCoreApplication.translate("ComSys", u"PCM", None))
    # retranslateUi
